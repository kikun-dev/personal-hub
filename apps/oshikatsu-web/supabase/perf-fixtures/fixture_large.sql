...
DO $$
DECLARE
  c_member_count int := 90;
  c_graduation_every_n int := 5; -- 5人に1人(約20%)を卒業済みにする（largeのみ）
  v_group_ids uuid[];
  i int;
  v_id uuid;
  v_month int;
...
DO $$
DECLARE
  c_event_count int := 700;
  c_onthisday_years int[] := ARRAY[2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025];
...
DO $$
BEGIN
  RAISE NOTICE '--- perf-fixture summary (large) ---';
