...
DO $$
DECLARE
  c_event_count int := 220;
  c_onthisday_years int[] := ARRAY[2022, 2023, 2024, 2025];
...
DO $$
BEGIN
  RAISE NOTICE '--- perf-fixture summary (medium) ---';
