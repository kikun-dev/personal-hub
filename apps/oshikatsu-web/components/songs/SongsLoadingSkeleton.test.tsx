...
// #486: app/(authenticated)/songs/page.tsxはasync Server Componentのためjsdomから
...
describe("components/songs/SongsLoadingSkeleton.tsx", () => {
  it("filter rowとcard gridのplaceholderを持ち、空要素だけではない", () => {
    const { container } = render(<SongsLoadingSkeleton />);
